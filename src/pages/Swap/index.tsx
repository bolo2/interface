...
import { ChainId, CurrencyAmount, JSBI, Token, Trade } from 'bolo2-sdk'
...
export default function Swap() {
    ...
    return (
        <>
            <Helmet>
                <title>{i18n._(t`Swap`)} | bolo.fund</title>
                <meta
                    name="description"
                    content="bolo.fund allows for swapping of ERC20 compatible tokens across multiple networks"
                />
            </Helmet>
            <TokenWarningModal
