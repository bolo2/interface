...
function Web3Network(): JSX.Element | null {
    ...
    return (
        ...
        >
            <div className="grid grid-flow-col auto-cols-max items-center rounded-lg bg-white text-sm text-secondary py-2 px-3 pointer-events-auto">
                <img
                ...
                />
                <div className="text-light-green">{NETWORK_LABEL[chainId]}</div>
            </div>
            {/* <div
