        ...
        <div className="flex items-center justify-center">
            <div className="w-full">
                ...
                >
                    {({ open }) => (
                        <>
                            <Listbox.Label className="block text-base leading-5 font-medium pb-2">
                                {label}
                            </Listbox.Label>
                            <div className="relative">
                                <span className="inline-block w-full rounded-md shadow-sm">
                                    <Listbox.Button className="cursor-pointer relative w-full rounded-md border border-dark-800 p-3 text-left focus:outline-none focus:shadow-outline-blue focus:border-blue-300 transition ease-in-out duration-150 sm:text-sm sm:leading-5">
                                        <span className="truncate flex items-center">
                                            ...
                                            />
                                            <span className="text-lg text-white font-bold">{selectedToken.symbol}&nbsp;</span>
                                            <span className="text-lg text-white">{selectedToken.name}</span>
                                        </span>
