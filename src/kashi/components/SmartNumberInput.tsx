    ...
    return (
        <>
            ...
            <div className="flex items-center relative w-full mb-4">
                <NumericalInput
                    className={
                        'w-full p-3 bg-white rounded disabled:cursor-not-allowed disabled:bg-gray-500 disabled:opacity-50 disabled:ring disabled:ring-dark-800 focus:ring focus:ring-' +
                        color
                    }
                    value={value}
